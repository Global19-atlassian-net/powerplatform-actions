...
describe('authHandler#input validations', () => {
    ...
    it('authHandler correct uses username/password auth flow when username/password are passed as input params', async () => {
    ...
    it('authHandler correct uses SPN auth flow when appId/clientSecret are passed as input params', async() => {
